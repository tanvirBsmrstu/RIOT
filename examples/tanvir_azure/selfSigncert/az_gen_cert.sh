...
echo "-------------Device cert-----------------"
openssl genrsa -out ./private/${DeviceID}.key.pem 4096
...
openssl ca -batch -config ./openssl_device_intermediate_ca.cnf -passin pass:1234 -extensions usr_cert -days 30 -notext -md sha256 -in ./csr/${DeviceID}.csr.pem -out ./certs/${DeviceID}.cert.pem
