...
// int get_info_from_clientd(AzRiotContext *azContext, azRiotClientType clientType, azRiotQueryWrapper query, char *result_out_buf, int max_result_out_buf_len, size_t *result_out_buf_len)
// {
...
//         if (azContext == NULL)
//         {
//             puts("AzRiotContext is not initialized");
//             return -1;
//         }
//         switch (clientType)
//         {
...
//             if (azContext->iot_hub_client == NULL)
//             {
//                 puts("iot hub client is not initialized");
//                 return -1;
//             }
//             if (az_result_failed(az_iot_hub_client_get_client_id(azContext->iot_hub_client, result_out_buf, max_result_out_buf_len, result_out_buf_len)))
//             {
//                 printf("az_iot_hub_client_get_client_id failed\n");
//                 return -1;
//             }
...
//             {
//                 puts("iot dps client is not initialized");
//                 return -1;
//             }
//             if (az_result_failed(az_iot_provisioning_client_get_client_id(azContext->dps_client, result_out_buf, max_result_out_buf_len, result_out_buf_len)))
//             {
//                 printf("az_iot_dps_client_get_client_id failed\n");
//                 return -1;
//             }
//             return 0;
...
//                 return -1;
//             }
//             if (az_result_failed(az_iot_hub_client_get_user_name(azContext->iot_hub_client, result_out_buf, max_result_out_buf_len, result_out_buf_len)))
//             {
//                 printf("az_iot_provisioning_client_get_user_name failed\n");
//                 return -1;
//             }
...
//                 return -1;
//             }
//             if (az_result_failed(az_iot_provisioning_client_get_user_name(azContext->dps_client, result_out_buf, max_result_out_buf_len, result_out_buf_len)))
//             {
//                 printf("az_iot_provisioning_client_get_user_name failed\n");
//                 return -1;
//             }
...
//             if ((size_t)required_size > max_result_out_buf_len)
//             {
//                 puts("Failed to create MQTT endpoint: Buffer is too small.");
//                 return -1;
//             }

//             az_span provisioning_mqtt_endpoint = az_span_create((uint8_t *)result_out_buf, max_result_out_buf_len);
